            ...
            {/* Sign UP */}
             <div className="form-containers sign-up-containers">
                <form className='register-form px-5 sm:px-[50px]' action="#">
                    ...
                    <input className='register-input text-xs md:text-base' type="text" placeholder="Username" />
                    <input className='register-input text-xs md:text-base' type="text" placeholder="Fullname" />
                    ...
                    <input className='register-input text-xs md:text-base' type="password" placeholder="Confrim Password" />
